...
export default function UserSubmissions() {
  ...
  return (
    <div className="relative">
      ...
      {/* Submissions container - horizontal on mobile, grid on desktop */}
      <div className="relative -mx-4 px-4 sm:mx-0 sm:px-0">
        <div
          ref={scrollContainerRef}
          className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory md:snap-none pb-4 md:pb-0 -mb-4 md:mb-0 scrollbar-hide"
        >
          {submissions.map((submission) => (
            <div
              key={submission.id}
              className="w-[80vw] sm:w-[55vw] md:w-auto flex-shrink-0 snap-start"
            >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    <div className="text-xs text-gray-500">
                      by {submission.userInput.submitterName}
                    </div>
      ...
      <div className="mt-4 text-center text-sm text-gray-500 md:hidden">Swipe to see more →</div>
    </div>
  );
}
